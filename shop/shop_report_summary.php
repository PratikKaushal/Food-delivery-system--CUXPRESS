...
<head>
    ...
    <title>Shop Revenue Report | CU Feast</title>
</head>
                ...
                <div class="col">
                    <div class="card border-secondary">
                        <div class="card-body">
                            <h5 class="card-title">
                                <?php
                                    if($num_order == 0){echo "0.00 rupees";}
                                    else{printf("%.2f rupees",$grandtotal/$num_order);}
                                ?>
                            </h5>
                ...
                <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-5">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row["f_price"]." rupees"?></td>
                            <td><?php echo $row["amount"]." plates"?></td>
                            <td><?php echo $row["subtotal"]." rupees"?></td>
                        </tr>
                        <?php } ?>
                        <tr class="fw-bold table-info">
                            <td colspan="4" class="text-end">Grand Total</td>
                            <td><?php printf("%.2f rupees",$grandtotal);?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
