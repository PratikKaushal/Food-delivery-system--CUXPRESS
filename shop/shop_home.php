...
<head>
    ...
    <title>Shop Owner Home | CU Feast</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-3">
            ...
            <p class="lead fw-normal">Chandigarh University Campus Canteen</p>
            <span class="xsmall-font text-muted">Food ordering system of Chandigarh University Campus Canteen</span>
        </div>
    </div>
