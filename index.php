...
<body class="d-flex flex-column h-100">
    ...
    <div class="position-relative d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-5">
            <h1 class="display-5 fw-normal">Welcome to CU XPRESS</h1>
    ...
    <footer
        ...
        <span class="smaller-font">&copy; 2024 Chandigarh University<br /><span class="xsmall-font">Made with love by Pratik Kaushal and Team❤️</span></span>
